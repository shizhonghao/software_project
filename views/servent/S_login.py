...
class Ui_S_Login(QWidget):
    ...
    def setupUi(self,parent):
        ...
        self.Form.setGeometry(QtCore.QRect(200, 140, 400, 320))
        self.Form.setObjectName("Form")
        self.Form.resize(400, 320)
        ...
        self.widget_room.setGeometry(QtCore.QRect(60, 77, 300, 45))
        self.widget_room.setStyleSheet("background-color: rgba(255, 255, 127, 180);")
        ...
        self.lineEdit_room.setGeometry(QtCore.QRect(80, -1, 241, 52))
        self.lineEdit_room.setStyleSheet("border-color: rgba(255, 255, 255, 0);font: 11pt 'Adobe Hebrew';")
        self.lineEdit_room.setObjectName("lineEdit_room")

        #输入框-登录名
        self.widget = QtWidgets.QWidget(self.Form)
        self.widget.setGeometry(QtCore.QRect(60, 142, 300, 45))
        ...
        self.widget_2.setGeometry(QtCore.QRect(60, 210, 300, 45))
        ...
        self.pushButton.setGeometry(QtCore.QRect(250, 260, 110, 34))
